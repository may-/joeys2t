    ...
    for lang in languages:
        ...
        for split in SPLITS:
            ...
            dataset_dict[split] = load_dataset(
                "mustc", split=split, name=f"en-{lang}", data_dir=root.as_posix()
            )
        ...
        kwargs = {
            ...
            'character_coverage': CHARACTER_COVERAGE[lang], 'num_workers': N_WORKERS,
...
def main():
    ...
    parser.add_argument("--trg-lang", default="de", required=True, type=str, nargs='+')
