...
class SpecAugment:
    ...
    def __repr__(self):
        return (
            f"{self.__class__.__name__}(freq_mask_n={self.freq_mask_n}, "
...
class CMVN:
    ...
    def __init__(
        self, norm_means: bool = True, norm_vars: bool = True, before: bool = True
    ):
    ...
    def __repr__(self):
        return (
            f"{self.__class__.__name__}(norm_means={self.norm_means}, "
